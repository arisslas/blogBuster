...
public class PostDAO {
    ...
    public ArrayList<PostBean> getPage(int page, int rpp, String campo, String orden) throws SQLException {
        ...
        if (page > 0 && rpp > 0) {
            ...
            throw new InternalServerErrorException("pagina no existente");
        }

        if (campo.equalsIgnoreCase("id") || campo.equalsIgnoreCase("titulo") || campo.equalsIgnoreCase("cuerpo") || campo.equalsIgnoreCase("fecha") || campo.equalsIgnoreCase("visible") || campo.equalsIgnoreCase("etiquetas")) {
            oPreparedStatement = oConnection.prepareStatement("SELECT * FROM post ORDER BY " + campo + " " + orden + " LIMIT ? OFFSET ?");
            ...
            throw new InternalServerErrorException("campo incorrecto");
        }
    }
